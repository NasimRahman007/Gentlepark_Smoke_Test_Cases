...
edit_button = wait_3.until(expected_conditions.visibility_of_element_located((By.XPATH, "(//button[@type='button'][normalize-space()='Edit'])[1]")))
edit_button.click()


driver.find_element(By.XPATH, "//input[@placeholder='Phone Number*']").clear()

driver.find_element(By.XPATH, "//input[@placeholder='Phone Number*']").send_keys("+8801758929480")
