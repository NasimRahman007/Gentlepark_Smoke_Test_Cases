...
#remove_wishlist_after_adding_again_to_wishlist
...
# click on the wishlist icon again to remove the item from wishlist
wait_4 = WebDriverWait(driver, 15)
item_removed_from_wishlist = wait_4.until(expected_conditions.invisibility_of_element_located((By.XPATH, "(//div[contains(text(),'Steel Blue Zip Polo Shirt... added to wishlist!')])[1]")))
driver.find_element(By.XPATH, '//div[@class="relative inline-block cursor-pointer"]').click()
time.sleep(2)

print("Test case passed: Item added to wishlist and then removed successfully.")
