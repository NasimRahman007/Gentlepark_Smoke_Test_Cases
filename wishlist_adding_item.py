...
wishlist_side_menu = wait_6.until(expected_conditions.element_to_be_clickable((By.XPATH, "//body[1]/main[1]/div[1]/div[1]/div[2]/div[1]/div[3]/ul[1]/button[2]/li[1]/span[1]")))
wishlist_side_menu.click()
time.sleep(1)


#get the number of wishlist items from side menu
wait_7 = WebDriverWait(driver, 15)
number_of_wishlist_item = wait_7.until(expected_conditions.visibility_of_element_located((By.XPATH, "(//p[@class='typo-14sbc'])[1]"))).text
print("Number of wishlist items from side menu:", number_of_wishlist_item)

#closing the wishlist side menu
driver.find_element(By.XPATH, "//button[@class='flex justify-center items-center']").click()
time.sleep(2)

wait_8 = WebDriverWait(driver, 15)
number_of_wishlist_item_from_menu = wait_8.until(expected_conditions.visibility_of_element_located((By.XPATH, "//body/main/div/div/div/div/div/ul/button[2]/li[1]/span[1]"))).text
print("Number of wishlist items from menu:", number_of_wishlist_item_from_menu)

assert number_of_wishlist_item == number_of_wishlist_item_from_menu, "Item was added to wishlist"
